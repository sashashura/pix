...
// @ts-expect-error TS(2451): Cannot redeclare block-scoped variable 'neutralize... Remove this comment to see the full error message
...
// @ts-expect-error TS(2451): Cannot redeclare block-scoped variable 'doNotResol... Remove this comment to see the full error message
...
class CertificationIssueReportResolutionStrategies {
  _certificationIssueReportRepository: $TSFixMe;
  _challengeRepository: $TSFixMe;
  _doNotResolve: $TSFixMe;
  _neutralizeIfAttachment: $TSFixMe;
  _neutralizeIfImageOrEmbed: $TSFixMe;
  _neutralizeIfTimedChallenge: $TSFixMe;
  _neutralizeOrValidateIfFocusedChallenge: $TSFixMe;
  _neutralizeWithoutChecking: $TSFixMe;
  constructor({
...
function _neutralizeAndResolve(certificationAssessment: $TSFixMe, certificationIssueReportRepository: $TSFixMe, certificationIssueReport: $TSFixMe) {
  const questionNumber = certificationIssueReport.questionNumber;
...
function _validateAnswerAndResolve(
  ...
  certificationIssueReportRepository: $TSFixMe,
  certificationIssueReport: $TSFixMe
) {
  const questionNumber = certificationIssueReport.questionNumber;
...
async function _resolveWithQuestionNeutralized(certificationIssueReportRepository: $TSFixMe, certificationIssueReport: $TSFixMe) {
...
async function _resolveWithNoAttachmentInChallenge(certificationIssueReportRepository: $TSFixMe, certificationIssueReport: $TSFixMe) {
  certificationIssueReport.resolveAutomatically(
...
async function _resolveWithNoFocusedChallenge(certificationIssueReportRepository: $TSFixMe, certificationIssueReport: $TSFixMe) {
  certificationIssueReport.resolveAutomatically(
...
async function _resolveWithChallengeNotTimed(certificationIssueReportRepository: $TSFixMe, certificationIssueReport: $TSFixMe) {
  certificationIssueReport.resolveAutomatically(
...
async function _resolveWithAnswerIsCorrect(certificationIssueReportRepository: $TSFixMe, certificationIssueReport: $TSFixMe) {
...
async function _resolveWithAnswerValidated(certificationIssueReportRepository: $TSFixMe, certificationIssueReport: $TSFixMe) {
