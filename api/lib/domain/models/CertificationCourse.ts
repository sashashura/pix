...
class CertificationCourse {
  _abortReason: $TSFixMe;
  _assessment: $TSFixMe;
  _birthCountry: $TSFixMe;
  _birthINSEECode: $TSFixMe;
  _birthPostalCode: $TSFixMe;
  _birthdate: $TSFixMe;
  _birthplace: $TSFixMe;
  _certificationIssueReports: $TSFixMe;
  _challenges: $TSFixMe;
  _complementaryCertificationCourses: $TSFixMe;
  _completedAt: $TSFixMe;
  _createdAt: $TSFixMe;
  _externalId: $TSFixMe;
  _firstName: $TSFixMe;
  _hasSeenEndTestScreen: $TSFixMe;
  _id: $TSFixMe;
  _isCancelled: $TSFixMe;
  _isPublished: $TSFixMe;
  _isV2Certification: $TSFixMe;
  _lastName: $TSFixMe;
  _maxReachableLevelOnCertificationDate: $TSFixMe;
  _sessionId: $TSFixMe;
  _sex: $TSFixMe;
  _userId: $TSFixMe;
  _verificationCode: $TSFixMe;
  constructor({
    id,
    firstName,
    lastName,
  ...
  withAssessment(assessment: $TSFixMe) {
    return new CertificationCourse({
      ...this.toDTO(),
  ...
  reportIssue(issueReport: $TSFixMe) {
  ...
  correctFirstName(modifiedFirstName: $TSFixMe) {
  ...
  correctLastName(modifiedLastName: $TSFixMe) {
  ...
  correctBirthplace(modifiedBirthplace: $TSFixMe) {
  ...
  correctSex(modifiedSex: $TSFixMe) {
  ...
  correctBirthdate(modifiedBirthdate: $TSFixMe) {
...
function _sanitizedString(string: $TSFixMe) {
