...
class CampaignParticipant {
  ...
  campaignToStartParticipation: $TSFixMe;
  organizationLearner: $TSFixMe;
  organizationLearnerHasParticipatedForAnotherUser: $TSFixMe;
  organizationLearnerId: $TSFixMe;
  previousCampaignParticipationForUser: $TSFixMe;
  userIdentity: $TSFixMe;
  constructor({
  ...
  _checkCanParticipateToCampaign(participantExternalId: $TSFixMe) {
  ...
  _isMissingParticipantExternalId(participantExternalId: $TSFixMe) {
    return (
