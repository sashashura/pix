...
module.exports = {
  async findUserCertifications(request: $TSFixMe) {
  ...
  async getCertification(request: $TSFixMe) {
    const userId = request.auth.credentials.userId;
  ...
  async getCertificationByVerificationCode(request: $TSFixMe) {
  ...
  async getPDFAttestation(request: $TSFixMe, h: $TSFixMe) {
    const userId = request.auth.credentials.userId;
    const certificationId = request.params.id;
  ...
  async neutralizeChallenge(request: $TSFixMe, h: $TSFixMe) {
  ...
  async deneutralizeChallenge(request: $TSFixMe, h: $TSFixMe) {
    const challengeRecId = request.payload.data.attributes.challengeRecId;
    const certificationCourseId = request.payload.data.attributes.certificationCourseId;
    const juryId = request.auth.credentials.userId;
