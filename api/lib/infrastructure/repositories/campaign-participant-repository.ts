...
async function save(campaignParticipant: $TSFixMe, domainTransaction: $TSFixMe) {
...
async function _createNewOrganizationLearner(organizationLearner: $TSFixMe, queryBuilder: $TSFixMe) {
...
async function _updatePreviousParticipation(campaignParticipation: $TSFixMe, queryBuilder: $TSFixMe) {
...
async function _createNewCampaignParticipation(queryBuilder: $TSFixMe, campaignParticipation: $TSFixMe) {
  try {
    ...
    if ((error as $TSFixMe).constraint === 'campaign_participations_campaignid_userid_isimproved_deleted') {
...
async function _createAssessment(assessment: $TSFixMe, campaignParticipationId: $TSFixMe, queryBuilder: $TSFixMe) {
  if (assessment) {
...
function _getUserIdentityForTrainee(userId: $TSFixMe, domainTransaction: $TSFixMe) {
  return domainTransaction.knexTransaction('users').select('id', 'firstName', 'lastName').where({ id: userId }).first();
}

async function _getCampaignToStart(campaignId: $TSFixMe, domainTransaction: $TSFixMe) {
...
async function _getOrganizationLearner(campaignId: $TSFixMe, userId: $TSFixMe, domainTransaction: $TSFixMe) {
...
async function _findpreviousCampaignParticipationForUser(campaignId: $TSFixMe, userId: $TSFixMe, domainTransaction: $TSFixMe) {
