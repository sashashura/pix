...
exports.up = async function (knex: $TSFixMe) {
  ...
  return knex.schema.table(TABLE_NAME, (table: $TSFixMe) => table.dropUnique(['studentNumber', 'organizationId']));
};

// @ts-expect-error TS(2304): Cannot find name 'exports'.
exports.down = async function (knex: $TSFixMe) {
  await knex.schema.table(TABLE_NAME, (table: $TSFixMe) => table.unique(['studentNumber', 'organizationId']));
  await knex.raw(
