...
// @ts-expect-error TS(2451): Cannot redeclare block-scoped variable 'PRO_TOOLS_... Remove this comment to see the full error message
...
function _createPixEmploiCleaBadge({
  databaseBuilder,
  id,
  key,
  targetProfileId,
  skillIdsForSkillSets
}: $TSFixMe) {
...
function _createPixEmploiCleaBadgeV1(databaseBuilder: $TSFixMe) {
...
function _createPixEmploiCleaBadgeV2(databaseBuilder: $TSFixMe) {
  return _createPixEmploiCleaBadge({
    databaseBuilder,
...
function _createPixEmploiCleaBadgeV3(databaseBuilder: $TSFixMe) {
  return _createPixEmploiCleaBadge({
    databaseBuilder,
...
function _createBasicsBadge(databaseBuilder: $TSFixMe) {
...
function _createToolsBadge(databaseBuilder: $TSFixMe) {
...
function _createManipBadge(databaseBuilder: $TSFixMe) {
...
function _createProfessionalBasicsBadge(databaseBuilder: $TSFixMe) {
  const basicsBadge = databaseBuilder.factory.buildBadge({
...
function _createProfessionalToolsBadge(databaseBuilder: $TSFixMe) {
  const toolsBadge = databaseBuilder.factory.buildBadge({
...
function _createPixDroitBadge(databaseBuilder: $TSFixMe) {
...
function _createPixEduBadges(databaseBuilder: $TSFixMe) {
...
function _returnIds(...builders: $TSFixMe[]) {
  return builders.map((builder) => builder.id);
}

function _associateSkillSets(databaseBuilder: $TSFixMe, targetProfileSkillIds: $TSFixMe, badge: $TSFixMe) {
  return _returnIds(
    databaseBuilder.factory.buildSkillSet({
      name: 'Rechercher des informations sur internet',
      skillIds: targetProfileSkillIds[0].map((id: $TSFixMe) => id),
      badgeId: badge.id,
    }),
    databaseBuilder.factory.buildSkillSet({
      name: 'Utiliser des outils informatiques',
      skillIds: targetProfileSkillIds[1].map((id: $TSFixMe) => id),
      badgeId: badge.id,
    }),
    databaseBuilder.factory.buildSkillSet({
      name: 'Naviguer sur internet',
      skillIds: targetProfileSkillIds[2].map((id: $TSFixMe) => id),
      badgeId: badge.id,
    }),
    databaseBuilder.factory.buildSkillSet({
      name: 'Partager sur les réseaux sociaux',
      skillIds: targetProfileSkillIds[3].map((id: $TSFixMe) => id),
      badgeId: badge.id,
    }),
  );
}

function _associateBadgeCriteria(databaseBuilder: $TSFixMe, badge: $TSFixMe, skillSetsIds = []) {
  databaseBuilder.factory.buildBadgeCriterion({
...
function _associatePixDroitMasterSkillSets(databaseBuilder: $TSFixMe, targetProfileSkillIds: $TSFixMe, badge: $TSFixMe) {
  return _returnIds(
    databaseBuilder.factory.buildSkillSet({
...
function _associatePixDroitExpertSkillSets(databaseBuilder: $TSFixMe, targetProfileSkillIds: $TSFixMe, badge: $TSFixMe) {
  return _returnIds(
    databaseBuilder.factory.buildSkillSet({
      name: 'Acquis du référentiel Pix',
      skillIds: targetProfileSkillIds[0].map((id: $TSFixMe) => id),
...
function _associatePixDroitMasterBadgeCriteria(databaseBuilder: $TSFixMe, badge: $TSFixMe, skillSetsIds: $TSFixMe) {
  databaseBuilder.factory.buildBadgeCriterion({
    scope: BadgeCriterion.SCOPES.SKILL_SET,
    threshold: 70,
    badgeId: badge.id,
...
function _associatePixDroitExpertBadgeCriteria(databaseBuilder: $TSFixMe, badge: $TSFixMe, skillSetsIds: $TSFixMe) {
  databaseBuilder.factory.buildBadgeCriterion({
    scope: BadgeCriterion.SCOPES.SKILL_SET,
    threshold: 70,
    badgeId: badge.id,
...
function _associatePixEduFormationInitialeSkillSets(
  ...
  skillIdsForPixEduDomain1: $TSFixMe,
  skillIdsForPixEduDomain2: $TSFixMe,
  badge: $TSFixMe,
) {
  return _returnIds(
    databaseBuilder.factory.buildSkillSet({
      name: 'Domaine Pix+ Édu Domaine 1',
      skillIds: skillIdsForPixEduDomain1.map((id: $TSFixMe) => id),
      badgeId: badge.id,
    }),
    databaseBuilder.factory.buildSkillSet({
      name: 'Domaine Pix+ Édu Domaine 2',
      skillIds: skillIdsForPixEduDomain2.map((id: $TSFixMe) => id),
      badgeId: badge.id,
    }),
  );
}

function _associatePixEduFormationContinueSkillSets(databaseBuilder: $TSFixMe, skillIdsForPixEduDomain3: $TSFixMe, badge: $TSFixMe) {
  return _returnIds(
    databaseBuilder.factory.buildSkillSet({
      name: 'Domaine Pix+ Édu Domaine 3',
      skillIds: skillIdsForPixEduDomain3.map((id: $TSFixMe) => id),
      badgeId: badge.id,
    }),
  );
}
