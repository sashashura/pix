...
function targetProfilesBuilder({
  databaseBuilder
}: $TSFixMe) {
...
function _buildTargetProfilePICDiagnosticInitial(databaseBuilder: $TSFixMe) {
...
function _buildTargetProfileOneCompetence(databaseBuilder: $TSFixMe) {
  databaseBuilder.factory.buildTargetProfile({
...
function _buildTargetProfileWithStagesAndBadges(databaseBuilder: $TSFixMe) {
  databaseBuilder.factory.buildTargetProfile({
...
function _buildTargetProfileWithSimplifiedAccess(databaseBuilder: $TSFixMe) {
  databaseBuilder.factory.buildTargetProfile({
...
function _buildTargetProfilePixEmploiClea({
  databaseBuilder,
  id,
  name,
  targetProfileSkillIdsForCleaBadge
}: $TSFixMe) {
  databaseBuilder.factory.buildTargetProfile({
    id,
    name,
  ...
  targetProfileSkillIdsForCleaBadge.flatMap(identity).forEach((skillId: $TSFixMe) => {
    databaseBuilder.factory.buildTargetProfileSkill({ targetProfileId: id, skillId });
  });
}
function _buildTargetProfilePixEmploiCleaV1(databaseBuilder: $TSFixMe) {
...
function _buildTargetProfilePixEmploiCleaV2(databaseBuilder: $TSFixMe) {
  return _buildTargetProfilePixEmploiClea({
    databaseBuilder,
...
function _buildTargetProfilePixEmploiCleaV3(databaseBuilder: $TSFixMe) {
  return _buildTargetProfilePixEmploiClea({
    databaseBuilder,
...
function _buildTargetProfilePixDroit(databaseBuilder: $TSFixMe) {
  databaseBuilder.factory.buildTargetProfile({
...
function _buildTargetProfilePixEduFormationInitiale2ndDegre(databaseBuilder: $TSFixMe) {
  databaseBuilder.factory.buildTargetProfile({
...
function _buildTargetProfilePixEduFormationInitiale1erDegre(databaseBuilder: $TSFixMe) {
  databaseBuilder.factory.buildTargetProfile({
...
function _buildTargetProfilePixEduFormationContinue2ndDegre(databaseBuilder: $TSFixMe) {
  databaseBuilder.factory.buildTargetProfile({
...
function _buildTargetProfilePixEduFormationContinue1erDegre(databaseBuilder: $TSFixMe) {
  databaseBuilder.factory.buildTargetProfile({
...
function _buildTargetProfileCnav(databaseBuilder: $TSFixMe) {
  databaseBuilder.factory.buildTargetProfile({
