  ...
  describe('#createOrUpdateOrganizations', function () {
    ...
    it('should create or update organizations', async function () {
      ...
      const networkStub1 = nock('http://localhost:3000', {
        ...
        .patch('/api/organizations/2', (body: $TSFixMe) => JSON.stringify(body) === JSON.stringify(expectedPatchBody))
        .reply(204, () => {
          patchCallCount++;
      ...
      const networkStub2 = nock('http://localhost:3000', {
        ...
        .post('/api/organizations', (body: $TSFixMe) => JSON.stringify(body) === JSON.stringify(expectedPostBody))
        .reply(201, () => {
          postCallCount++;
