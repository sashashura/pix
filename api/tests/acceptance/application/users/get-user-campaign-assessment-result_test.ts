...
describe('Acceptance | API | Campaign Assessment Result', function () {
  ...
  let user: $TSFixMe, campaign: $TSFixMe, assessment: $TSFixMe, campaignParticipation: $TSFixMe, targetProfile: $TSFixMe, targetProfileSkills;

  let server: $TSFixMe, badge: $TSFixMe, skillSet: $TSFixMe, stage: $TSFixMe;
  ...
  beforeEach(async function () {
    ...
    targetProfileSkills = _.times(8, (index: $TSFixMe) => {
    ...
    targetProfileSkills.slice(2).forEach((targetProfileSkill: $TSFixMe, index: $TSFixMe) => {
