...
describe('Unit | Application | Router | answer-router', () => {
  ...
  describe('POST /api/answers', () => {
    ...
    it('should return 201', async () => {
      ...
      sinon.assert.calledOnce(answerController.save);
    });
  });
  ...
  describe('GET /api/answers/{id}', () => {
    ...
    it('should return 200', async () => {
      ...
      sinon.assert.calledOnce(answerController.get);
    });
  });
  ...
  describe('PATCH /api/answers/{id}', () => {
    ...
    it('should return 204', async () => {
      ...
      sinon.assert.calledOnce(answerController.update);
    });
  });
  ...
  describe('GET /api/answers', () => {
    ...
    it('should return 200', async () => {
      ...
      // then
      expect(response.statusCode).to.equal(200);
      sinon.assert.calledOnce(answerController.find);
    });
  });
