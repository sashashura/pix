...
describe('Unit | Application | Organizations | organization-controller', function () {
  ...
  describe('#findPaginatedFilteredCampaigns', function () {
    ...
    let serializedCampaigns: $TSFixMe;
  ...
  describe('#attachTargetProfiles', function () {
    ...
    let organizationId: $TSFixMe;
    let targetProfileId;
    let targetProfilesToAttachAsArray: $TSFixMe;
  ...
  describe('#findPaginatedFilteredOrganizationLearners', function () {
    ...
    let studentWithUserInfo: $TSFixMe;
    let serializedStudentsWithUsersInfos: $TSFixMe;
    let request: $TSFixMe;
  ...
  describe('#findPaginatedFilteredScoParticipants', function () {
    ...
    let scoOrganizationParticipant: $TSFixMe;
    let serializedScoOrganizationParticipant: $TSFixMe;
    let request: $TSFixMe;
  ...
  describe('#findPaginatedFilteredSupParticipants', function () {
    ...
    let supOrganizationParticipant: $TSFixMe;
    let serializedSupOrganizationParticipant: $TSFixMe;
    let request: $TSFixMe;
  ...
  describe('#importorganizationLearnersFromSIECLE', function () {
    ...
    it('should call the usecase to import organizationLearners', async function () {
      // given
(request as $TSFixMe).i18n = getI18n();
