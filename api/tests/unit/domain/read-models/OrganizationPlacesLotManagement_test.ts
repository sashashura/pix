...
describe('Unit | Domain | ReadModels | organizationPlacesLotManagement', function () {
  ...
  describe('#status', function () {
    ...
    it('have expired status when expirationDate has passed.', function () {
      ...
      // then
expect(organizationPlacesLotManagement.status).to.equal((OrganizationPlacesLotManagement.statuses as $TSFixMe).EXPIRED);
    });
    ...
    it('have active status when place is currently active', function () {
      ...
      // then
expect(organizationPlacesLotManagement.status).to.equal((OrganizationPlacesLotManagement.statuses as $TSFixMe).ACTIVE);
    });
    ...
    it('have pending status when the place is not yet active', function () {
      ...
      // then
expect(organizationPlacesLotManagement.status).to.equal((OrganizationPlacesLotManagement.statuses as $TSFixMe).PENDING);
    });
...
expect(organizationPlacesLotManagement.status).to.equal((OrganizationPlacesLotManagement.statuses as $TSFixMe).PENDING);
  ...
  describe('#category', function () {
    ...
    it('have a free rate category when the given category is T0', function () {
      ...
      // then
expect(organizationPlacesLotManagement.category).to.equal((OrganizationPlacesLotManagement.categories as $TSFixMe).T0);
    });
    ...
    it('have a public rate category when the given category is T1', function () {
      ...
      // then
expect(organizationPlacesLotManagement.category).to.equal((OrganizationPlacesLotManagement.categories as $TSFixMe).T1);
    });
    ...
    it('have a reduce rate category when the given category is T2', function () {
      ...
      // then
expect(organizationPlacesLotManagement.category).to.equal((OrganizationPlacesLotManagement.categories as $TSFixMe).T2);
    });
    ...
    it('have a special reduce rate category when the given category is T2bis', function () {
      ...
      // then
expect(organizationPlacesLotManagement.category).to.equal((OrganizationPlacesLotManagement.categories as $TSFixMe).T2bis);
    });
    ...
    it('have a full rate category when the given category is T3', function () {
      ...
      // then
expect(organizationPlacesLotManagement.category).to.equal((OrganizationPlacesLotManagement.categories as $TSFixMe).T3);
    });
  });
});
