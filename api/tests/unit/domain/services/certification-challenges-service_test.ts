...
describe('Unit | Service | Certification Challenge Service', function () {
  ...
  let competenceFlipper: $TSFixMe;
  let competenceRemplir: $TSFixMe;
  let competenceRequin;
  let competenceKoala;

  let skillCitation4: $TSFixMe;
  let skillCollaborer4: $TSFixMe;
  let skillMoteur3: $TSFixMe;
  let skillRecherche4: $TSFixMe;
  let skillRemplir2: $TSFixMe;
  let skillRemplir2Focus: $TSFixMe;
  let skillRemplir4: $TSFixMe;
  let skillUrl3: $TSFixMe;
  let skillWeb1: $TSFixMe;
  let skillRequin5: $TSFixMe;
  let skillRequin8: $TSFixMe;
  let skillKoala1: $TSFixMe;
  let skillKoala2: $TSFixMe;

  let challengeForSkillCollaborer4: $TSFixMe;
  let challengeForSkillCitation4: $TSFixMe;
  let challengeForSkillRecherche4: $TSFixMe;
  let challengeRecordWithoutSkills: $TSFixMe;
  let anotherChallengeForSkillCitation4: $TSFixMe;
  let challengeForSkillKoala1: $TSFixMe;
  let challengeForSkillKoala2: $TSFixMe;
  let challengeForSkillRemplir2: $TSFixMe;
  let challengeForSkillRemplir2Focus: $TSFixMe;
  let challengeForSkillRemplir4: $TSFixMe;
  let challengeForSkillUrl3: $TSFixMe;
  let challengeForSkillWeb1: $TSFixMe;
  let challengeForSkillRequin5: $TSFixMe;
  let challengeForSkillRequin8: $TSFixMe;

  function _createCertificationChallenge(challengeId: $TSFixMe, skill: $TSFixMe, certifiableBadgeKey = null) {
  ...
  function findOperativeByIds(skillIds: $TSFixMe) {
    const skills = [
      skillCitation4,
      skillCollaborer4,
      skillMoteur3,
  ...
  describe('#pickCertificationChallenges', function () {
    let placementProfile: $TSFixMe;
    let userCompetence1: $TSFixMe;
    let userCompetence2: $TSFixMe;
  ...
  describe('#pickCertificationChallengesForPixPlus', function () {
    let targetProfileWithLearningContent: $TSFixMe;
    let clock: $TSFixMe;
    const now = new Date('2019-01-01T05:06:07Z');
    function _createTargetedTubeWithSkills({
      maxLevel,
      tubeName,
      tubeId,
      areaName
    ...
    function _createTargetedAreaForTubes({
      tubes,
      areaName,
      areaId,
      origin
    ...
    function _createChallengeWithDecl(challengeBaseId: $TSFixMe, skill: $TSFixMe, countDecl: $TSFixMe) {
      const challenges = [];
    ...
    it('should pick 4 challenges per area', async function () {
      ...
      // then
      let expectedCertificationChallenges: $TSFixMe = [];
      expectedCertificationChallenges = expectedCertificationChallenges.concat(
        _createCertificationChallenge(
          ...
          // @ts-expect-error TS(2345): Argument of type '"BADGE_KEY"' is not assignable t... Remove this comment to see the full error message
          'BADGE_KEY'
        )
      );
      expectedCertificationChallenges = expectedCertificationChallenges.concat(
