...
describe('Unit | Service | ScorecardService', function () {
  ...
  describe('#resetScorecard', function () {
    let resetCampaignParticipation: $TSFixMe;
    let resetKnowledgeElements: $TSFixMe;
    let resetCompetenceEvaluation: $TSFixMe;
    let assessmentRepository: $TSFixMe;
    let knowledgeElementRepository: $TSFixMe;
    let competenceEvaluationRepository: $TSFixMe;
    let campaignParticipationRepository: $TSFixMe;
    let targetProfileRepository: $TSFixMe;
    let resetKnowledgeElement1: $TSFixMe;
    let resetKnowledgeElement2: $TSFixMe;
