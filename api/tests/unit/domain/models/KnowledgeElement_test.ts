...
describe('Unit | Domain | Models | KnowledgeElement', function () {
  ...
  describe('#createKnowledgeElementsForAnswer', function () {
    ...
    let challenge: $TSFixMe;
    let easierSkill: $TSFixMe;
    let harderSkill: $TSFixMe;
    let muchEasierSkill: $TSFixMe;
    let muchHarderSkill: $TSFixMe;
    let skill: $TSFixMe;
    let invalidAnswer: $TSFixMe;
    let validAnswer: $TSFixMe;
    ...
    context('and the skill is not in the target profile', function () {
      let otherSkill;
      let createdKnowledgeElements: $TSFixMe;
