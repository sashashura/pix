  ...
  describe('#serialize()', function () {
    ...
    data: {
        ...
        attributes: {
            ...
            date: '2017-01-20',
            time: '14:30',
            status: (statuses as $TSFixMe).PROCESSED,
            description: '',
  ...
  describe('#deserialize()', function () {
    ...
    data: {
        ...
        attributes: {
            ...
            status: (statuses as $TSFixMe).CREATED,
            description: '',
    ...
    EMPTY_BLANK_AND_NULL.forEach((examinerGlobalComment) => {
      ...
      it(`should return no examiner comment if comment is "${examinerGlobalComment}"`, function () {
        ...
        // then
expect(result.examinerGlobalComment).to.deep.equal((Session as $TSFixMe).NO_EXAMINER_GLOBAL_COMMENT);
      });
    });
  });
});
