...
function turnIntoTimedChallenge(challenge: $TSFixMe) {
  return _.assign(_.cloneDeep(challenge), { timer: ONE_MINUTE });
}

function duplicateChallengeOfSameDifficulty(challenge: $TSFixMe) {
...
describe('Integration | Domain | Algorithm-methods | SmartRandom', function () {
  let challenges,
    ...
    cnil1: $TSFixMe,
    cnil2: $TSFixMe,
    challengeWeb_1: $TSFixMe,
    challengeWeb_2: $TSFixMe,
    challengeWeb_2_3: $TSFixMe,
    challengeWeb_3: $TSFixMe,
    challengeWeb_4: $TSFixMe,
    challengeWeb_5: $TSFixMe,
    challengeWeb_6: $TSFixMe,
    challengeWeb_7: $TSFixMe,
    challengeUrl_2: $TSFixMe,
    challengeUrl_3: $TSFixMe,
    challengeUrl_4: $TSFixMe,
    challengeUrl_5: $TSFixMe,
    challengeUrl_6: $TSFixMe,
    challengeRechInfo_5: $TSFixMe,
    challengeRechInfo_7: $TSFixMe,
    challengeInfo_2_frAndEn: $TSFixMe,
    challengeCnil_1: $TSFixMe,
    challengeCnil_2: $TSFixMe;
