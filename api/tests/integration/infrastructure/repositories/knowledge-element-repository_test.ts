...
describe('Integration | Repository | knowledgeElementRepository', function () {
  ...
  describe('#save', function () {
    let knowledgeElementToSave: $TSFixMe;
  ...
  describe('#findUniqByUserId', function () {
    ...
    let knowledgeElementsWanted: $TSFixMe, knowledgeElementsWantedWithLimitDate: $TSFixMe;
    let userId: $TSFixMe;
    ...
    beforeEach(async function () {
      ...
      knowledgeElementsWantedWithLimitDate = _.map(
        ...
        (ke: $TSFixMe) => databaseBuilder.factory.buildKnowledgeElement(ke)
      );
    ...
    it('should be DomainTransaction compliant', async function () {
      ...
      // when
      const knowledgeElementsFound = await DomainTransaction.execute(async (domainTransaction: $TSFixMe) => {
  ...
  describe('#findUniqByUserIdAndAssessmentId', function () {
    let knowledgeElementsWanted: $TSFixMe;
  ...
  describe('findUniqByUserIdAndCompetenceId', function () {
    let wantedKnowledgeElements: $TSFixMe;
    let userId: $TSFixMe;
    let otherUserId;
  ...
  describe('findByCampaignIdForSharedCampaignParticipation', function () {
    let userId: $TSFixMe, targetProfileId: $TSFixMe, campaignId: $TSFixMe;
  ...
  describe('#findSnapshotGroupedByCompetencesForUsers', function () {
    ...
    context('when user does not have a snapshot for this date', function () {
      ...
      context('when no date is provided along with the user', function () {
        let expectedKnowledgeElement: $TSFixMe;
