...
export default class TermsOfServiceFwbController extends Controller {
  ...
  async submit() {
    if (this.isTermsOfServiceValidated) {
      ...
      try {
        await this.session.authenticate('authenticator:fwb', { authenticationKey: this.authenticationKey });
      } catch (error) {
